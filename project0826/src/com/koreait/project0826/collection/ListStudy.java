...
//컬렉션 프레임웍이 지원하는 객체 중 List계열의 객체를 학습한다!
//참고로 List는 순서가 있는 객체집합을 처리하므로,
//배열과 거의 같다!!
public class ListStudy {
	
	public static void main(String[] args) {
		//배열과의 차이?
		//1)생성시 크기 명시하지 않아도 된다. 즉 크기가 유동적이다..
		//2)배열은 기본자료형 및 객체자료형을 대상으로 데이터 넣지만, 컬렉션 프레임웍의 대상은 오직 객체만을 대상으로 함..
